...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--num_iters_validate', default=4, type=int, help='# batches to use when validating')
        self._parser.add_argument('--print_freq_s', type=int, default=60, help='frequency of showing training results on console')
        self._parser.add_argument('--display_freq_s', type=int, default=10, help='frequency [s] of showing training results on screen')
        self._parser.add_argument('--save_latest_freq_s', type=int, default=10000, help='frequency of saving the latest results')
