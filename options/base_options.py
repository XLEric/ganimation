...
class BaseOptions():
    ...
    def initialize(self):
        self._parser.add_argument('--data_dir', type=str, default='E:/m_cc/FaceSwap/FaceShifter/chs_stars_512px' ,help='path to dataset')
        ...
        self._parser.add_argument('--serial_batches', action='store_false', help='if true, takes images in order to make batches, otherwise takes them randomly')
