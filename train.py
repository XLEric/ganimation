...
class Train:
    ...
    def _train_epoch(self, i_epoch):
        ...
        for i_train_batch, train_batch in enumerate(self._dataset_train):
            ...
            # print(i_train_batch,train_batch.size())
            ...
            # display visualizer
            if do_visuals:
                self._display_visualizer_train(self._total_steps,save_visuals = True)
                self._display_visualizer_val(i_epoch, self._total_steps,save_visuals = True)
    ...
    def _display_visualizer_train(self, total_steps,save_visuals):
        self._tb_visualizer.display_current_results(self._model.get_current_visuals(), total_steps, is_train=True,save_visuals = save_visuals)
    ...
    def _display_visualizer_val(self, i_epoch, total_steps,save_visuals = True):
        ...
        self._tb_visualizer.display_current_results(self._model.get_current_visuals(), total_steps, is_train=False,save_visuals = save_visuals)
