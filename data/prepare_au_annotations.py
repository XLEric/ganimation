...
parser.add_argument('--input_aus_filesdir', type=str,default = 'E:/m_cc/FaceSwap/FaceShifter/chs_stars_512px/anno/', help='Dir with imgs aus files')
parser.add_argument('--output_path', type=str,default = 'E:/m_cc/FaceSwap/FaceShifter/chs_stars_512px/', help='Output path')
