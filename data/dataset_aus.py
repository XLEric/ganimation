...
class AusDataset(DatasetBase):
    ...
    def __getitem__(self, index):
        ...
        while real_img is None or real_cond is None:
            ...
            # print('real_img shape : s',real_img.shape)
            real_img = cv2.resize(real_img, (self.img_size,self.img_size), interpolation = cv2.INTER_LINEAR)
    ...
    def _read_dataset_paths(self):
        ...
        self._imgs_dir = self._root+'/'+self._opt.images_folder+'/'
